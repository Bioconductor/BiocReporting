...
The current Bioconductor release is [3.16 release announcement](https://bioconductor.org/news/bioc_3_16_release/), released on 2 November, 2022. It is
...
## Core Master Branch Renaming

The master branch (that corresponds to Bioconductor devel version) will be renamed to devel on git.bioconductor.org for all packages to move forward with diversity and inclusiveness.  The core has been doing extensive testing and is ready to move forward within the next 2-3 weeks.  
...
The BioC2023 and EuroBioC conferences have both been announced, and abstracts are open. BioC Asia will be announced later this year.
...
[EuroBioC](https://eurobioc2023.bioconductor.org/) will be held in Ghent, Belgium from Sep 20-22. Abstracts can be submitted until April 14.
...
- [Teaching Committee](https://workinggroups.bioconductor.org/currently-active-working-groups-committees.html#education)
    ...
    - Will be participating in [Galaxy Training Smorgasbord 2023](https://gallantries.github.io/video-library/events/smorgasbord3/), a free online event, May 22-26  
...
- [Social media working group](https://workinggroups.bioconductor.org/currently-active-working-groups-committees.html#social-media) have set up [Bioconductor Mastodon acccount](https://genomic.social/@bioconductor)
