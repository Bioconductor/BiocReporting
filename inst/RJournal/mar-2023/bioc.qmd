...
We will be making announcements on [bioc-devel mailing list](https://slack.bioconductor.org), [Twitter](https://twitter.com/Bioconductor), [Mastodon](https://genomic.social/@bioconductor), [Slack](https://slack.bioconductor.org), etc with an upcoming/heads up and an announcement when it is live.
